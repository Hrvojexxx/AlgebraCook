								...
								@foreach ($recipe->ingredients as $ingredient)
									<div class="form-group">
										<label for="ingredient">Sastojak: 
											...
											<a href="#" class="remScnt"><i class="fa fa-btn fa-close"></i>Ukloniti sastojak</a>
									</div>
								@endforeach
							</div>
							<a href="#" id="addLink"><i class="fa fa-btn fa-plus"></i>Dodaj nov sastojak</a><br>
							{{ csrf_field() }}
		...
		$('#addLink').click(function() {
			$('<div class="form-group">'+
				...
				'<a href="#" class="remScnt">'+
					'<i class="fa fa-btn fa-close"></i>Ukloni sastojak'+
